...
#define ORIGINAL_FILE_NAME "UE4Editor-FootIKEditor.dll"
#define UE_IS_ENGINE_MODULE 0
#define UE_BUILD_DEVELOPMENT_WITH_DEBUGGAME 0
#define UE_PROJECT_NAME PlatformerGame
#define DEPRECATED_FORGAME DEPRECATED
#define FOOTIKEDITOR_API DLLEXPORT
...
#define FOOTIKRUNTIME_API DLLIMPORT
